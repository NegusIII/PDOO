...
module Irrgarten
    class Game
        ...
        def initialize(n_players)
            @log=""
            @labyrinth = Labyrinth.new(3,2,2,1)
            @players = Array.new
            @monsters = Array.new
        ...
        def configure_labyrinth
            monstruo1 = Monster.new("1", Dice.random_intelligence, Dice.random_strength)
            monstruo2 = Monster.new("2", Dice.random_intelligence, Dice.random_strength)

            @labyrinth.add_monster(0,1,monstruo1)
            @labyrinth.add_monster(1,1,monstruo2)
