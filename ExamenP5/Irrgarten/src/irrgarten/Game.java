...
public class Game {
    ...
    private int bearerOfCataclysmIndex;
    
    private boolean cataclysmUsed;
    ...
    public Game(int nplayers){
        ...
        cataclysmUsed=false;
        bearerOfCataclysmIndex=Dice.BearerOfCataclysm(nplayers);
        
        monsters = new ArrayList<>();
        labyrinth = new Labyrinth(3,3,2,1);
    ...
    public GameState GameState(){
        ...
        monstersStr, currentPlayerIndex, this.finished(), log, bearerOfCataclysmIndex);
        return estado;
    }
    
    //Métodos publicos del cataclismo
    
    public boolean CataclysmAvailable(){
        return (currentPlayerIndex==bearerOfCataclysmIndex && !cataclysmUsed);
    }
    
    public void Cataclysm(){
        if (Dice.cataclysmHappens()){
            labyrinth.removeBlocks();
            labyrinth.spreadPlayers(players);
            cataclysmUsed=true;
        }
    }
    ...
    private void configureLabyrinth(){
        Monster monstruo1= new Monster("M1", 200, 200);
    ...
    private void logCataclysm(){
        if (cataclysmUsed){
            log+="Se han producido el cataclismo\n";
        }
    }
