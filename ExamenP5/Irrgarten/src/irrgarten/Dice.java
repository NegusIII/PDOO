...
public class Dice {
    ...
    private static float CATACLYSM_PROB=0.8f;
   ...
   public static boolean discardElement(int usesLeft){
    ...
    public static int BearerOfCataclysm(int nPlayers){
        return generator.nextInt(nPlayers);
    }
    
    public static boolean cataclysmHappens(){
        return generator.nextFloat()< CATACLYSM_PROB;
    }
}